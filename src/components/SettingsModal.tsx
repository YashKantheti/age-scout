...
export function SettingsModal({ open, onClose, onSave }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/70 flex items-end">
      <div className="bg-white w-full rounded-t-2xl p-6 max-w-md mx-auto slide-up">
        <div className="flex items-center justify-between mb-1">
          <h2 className="text-xl font-bold">Configure API</h2>
        ...
        <label className="block mb-5">
          <span className="text-xs font-bold uppercase tracking-wide text-text-muted block mb-1">Vision Model</span>
